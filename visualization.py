...
├─────────────────┼──────────────────────────┼────────────────────────────────┤
│ Distribution    │ plot_motif_distribution  │ Class/subclass distributions   │
│ Coverage        │ plot_coverage_map        │ Sequence coverage viz          │
│ Statistics      │ plot_score_distribution  │ Score and length distributions │
│ Nested          │ plot_nested_pie_chart    │ Class-subclass pie charts      │
│ Interactive     │ create_interactive_*     │ Interactive plotly charts      │
